...
export const en: TranslationStrings = {
  ...
  categoryKeywords: {
    ...
    DiningOut: ['restaurant', 'cafe', 'starbucks', 'mcdonalds', 'burger', 'pizza'],
    Shopping: ['amazon', 'ebay', 'shop', 'purchase'],
    Transport: ['uber', 'bolt', 'taxi', 'fuel', 'transport'],
    Entertainment: ['netflix', 'spotify', 'disney', 'cinema', 'gym', 'fitness', 'sport', 'entertainment'],
    Insurance: ['insurance'],
    Utilities: ['utility', 'internet'],
    Healthcare: ['doctor', 'pharmacy', 'health'],
    Savings: ['saving'],
