        ...
        >
          {selected ? (
            <div className={styles['country-option-content']}>
              <img
                src={selected.flag}
                alt={`${t.countries?.[selected.code] || selected.name} flag`}
                className={styles['country-flag']}
              />
              <span>{t.countries?.[selected.code] || selected.name}</span>
            </div>
          ) : (
                  ...
                  filtered.map((country) => (
                    ...
                    >
                      <div className={styles['country-option-content']}>
                        <img
                          src={country.flag}
                          alt={`${t.countries?.[country.code] || country.name} flag`}
                          className={styles['country-flag']}
                        />
                        <span>{t.countries?.[country.code] || country.name}</span>
                      </div>
                      {!country.supported && (
